...
namespace MobileTestAutomation.UIMap.SearchPage.clickSearchButton_MapClasses
{
    ...
    public partial class clickSearchButton_Map:logWriter
    {
        ...
        /// </summary>
        public void clickSearchButton_Method(string strURL)
        {
            #region Variable Declarations
            HtmlCustom uIItemCustom = this.UISearchVillaPlusWindoWindow.UISearchVillaPlusDocument.UISearchTilePane.UIItemCustom;
            #endregion
            ...
            try
            {
                ...
                WriteLogs("PASS : Clicked \'Search\' Button.");
            }
            catch (Exception ex)
            {
                WriteLogs("FAIL : Could not click \'Search\' Button." + ex.ToString());
            }
    ...
    public class UISearchVillaPlusDocument : HtmlDocument
    {
        ...
        #region Properties
        public UISearchTilePane UISearchTilePane
        {
            get
            {
                if ((this.mUISearchTilePane == null))
                {
                    this.mUISearchTilePane = new UISearchTilePane(this);
                }
                return this.mUISearchTilePane;
            }
        }
        #endregion
        
        #region Fields
        private UISearchTilePane mUISearchTilePane;
        #endregion
    }
    
    [GeneratedCode("Coded UITest Builder", "11.0.60315.1")]
    public class UISearchTilePane : HtmlDiv
    {
        
        public UISearchTilePane(UITestControl searchLimitContainer) : 
                base(searchLimitContainer)
        {
            #region Search Criteria
            this.SearchProperties[HtmlDiv.PropertyNames.Id] = "searchTile";
            this.FilterProperties.Add(new PropertyExpression(HtmlDiv.PropertyNames.InnerText, "Find Your Villa Holiday", PropertyExpressionOperator.Contains));
            this.FilterProperties.Add(new PropertyExpression(HtmlDiv.PropertyNames.ControlDefinition, "id=\"searchTile\"", PropertyExpressionOperator.Contains));
            this.WindowTitles.Add("Search | Villa Plus");
            #endregion
        }
        ...
        public HtmlCustom UIItemCustom
        {
            get
            {
                if ((this.mUIItemCustom == null))
                {
                    ...
                    this.mUIItemCustom.FilterProperties["Class"] = "btn bg-green";
                    this.mUIItemCustom.FilterProperties["ControlDefinition"] = "class=\"btn bg-green\"";
