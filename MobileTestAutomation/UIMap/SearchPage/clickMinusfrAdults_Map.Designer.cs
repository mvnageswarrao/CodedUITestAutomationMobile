...
namespace MobileTestAutomation.UIMap.SearchPage.clickMinusfrAdults_MapClasses
{
    ...
    public partial class clickMinusfrAdults_Map:logWriter
    {
        
        /// <summary>
        /// clickMinusfrAdults_Method
        /// </summary>
        public int clickMinusfrAdults_Method(int AdultstobeSelected)
        {
            ...
            while (defltNumofadults > AdultstobeSelected)
            {
                // Click '-' pane
            ...
            WriteLogs("PASS : \"" + NumofAdultSelected + "\" Adults Selected.");

            return NumofAdultSelected;
    }

        public int clickMinusfrsingleAdults_Method()
        {
            #region Variable Declarations
            HtmlSpan uIItemPane = this.UISearchVillaPlusWindoWindow.UISearchVillaPlusDocument.UIItem2AdultsPane.UIItemPane;
            HtmlControl UIItem2AdultsPane = this.UISearchVillaPlusWindoWindow.UISearchVillaPlusDocument.UIItem2AdultsPane;
        ...
        public void verifyMinusFrAdultsDisabled_Method()
        {
            #region Variable Declarations
            HtmlSpan uIItemPane = this.UISearchVillaPlusWindoWindow.UISearchVillaPlusDocument.UIItem2AdultsPane.UIItemPane;
            HtmlControl UIItem2AdultsPane = this.UISearchVillaPlusWindoWindow.UISearchVillaPlusDocument.UIItem2AdultsPane;
            ...
            WriteLogs("PASS : - icon for Aults has been disabled.");
        }
