...
namespace MobileTestAutomation.UIMap.SearchPage.clickNextArrowTwice_MapClasses
{
    ...
    public partial class clickNextArrowTwice_Map:logWriter
    {
        
        /// <summary>
        /// clickNextArrowTwice_Method
        /// </summary>
        public void clickNextArrowTwice_Method(int NumofNextclicks)
        {
            ...
            var btnPosition = uINextCustom.BoundingRectangle;
            Point relativePoint = new Point();
            relativePoint = new Point(btnPosition.X, btnPosition.Y);
            if (btnPosition.X != 0)
            {
                for (int i = 1; i <= NumofNextclicks; i++)
                {
            ...
            else
            {
                ...
                WriteLogs("INFO : Browser was Closed as the Next Month Control On Calender is Not Avaialble.");
            }        
        }
        ...
        public HtmlCustom UINextCustom
        {
            get
            {
                if ((this.mUINextCustom == null))
                {
                    ...
                    this.mUINextCustom.FilterProperties.Add(new PropertyExpression("Class", "ui-datepicker-next", PropertyExpressionOperator.Contains));
