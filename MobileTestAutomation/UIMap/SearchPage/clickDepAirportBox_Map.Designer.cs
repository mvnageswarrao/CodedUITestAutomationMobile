...
namespace MobileTestAutomation.UIMap.SearchPage.clickDepAirportBox_MapClasses
{
    ...
    public partial class clickDepAirportBox_Map
    {
        ...
        /// <summary>
        /// clickDepAirportBox_Method
        /// </summary>
        public string clickDepAirportBox_Method()
        {
            #region Variable Declarations
            HtmlHyperlink uIAllLondonHyperlink = this.UISearchVillaPlusWindoWindow.UISearchVillaPlusDocument.UIAllLondonHyperlink;
            #endregion

            string DefaultAirport = uIAllLondonHyperlink.InnerText;

            // Click 'All London' link
            Mouse.Click(uIAllLondonHyperlink, new Point(68, 16));
    ...
    public class UISearchVillaPlusDocument : HtmlDocument
    {
        ...
        #region Properties
        public HtmlHyperlink UIAllLondonHyperlink
        {
            get
            {
                if ((this.mUIAllLondonHyperlink == null))
                {
                    this.mUIAllLondonHyperlink = new HtmlHyperlink(this);
                    #region Search Criteria
                    this.mUIAllLondonHyperlink.SearchProperties[HtmlHyperlink.PropertyNames.Id] = "AirportText";
                    this.mUIAllLondonHyperlink.FilterProperties.Add(new PropertyExpression(HtmlHyperlink.PropertyNames.AbsolutePath, "showSlideControl(\'searchAirport\',%20\'divSelectAirport\');", PropertyExpressionOperator.Contains));
                    this.mUIAllLondonHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.Href] = "javascript:showSlideControl(\'searchAirport\', \'divSelectAirport\');";
                    this.mUIAllLondonHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.Class] = "fake-input";
                    this.mUIAllLondonHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.ControlDefinition] = "class=\"fake-input\" id=\"AirportText\" href";
                    this.mUIAllLondonHyperlink.WindowTitles.Add("Search | Villa Plus");
                    #endregion
                }
                return this.mUIAllLondonHyperlink;
            }
        }
        #endregion
        
        #region Fields
        private HtmlHyperlink mUIAllLondonHyperlink;
        #endregion
    }
}
