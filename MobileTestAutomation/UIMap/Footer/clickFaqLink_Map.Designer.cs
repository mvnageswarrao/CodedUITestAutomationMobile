...
namespace MobileTestAutomation.UIMap.Footer.clickFaqLink_MapClasses
{
    ...
    public partial class clickFaqLink_Map:logWriter
    {
        
        /// <summary>
        /// clickFaqLink_Method
        /// </summary>
        public void clickFaqLink_Method()
        {
            #region Variable Declarations
            HtmlHyperlink uIFAQsHyperlink = this.UIVillaHolidaysThatYouWindow.UIVillaHolidaysThatYouDocument.UIPanelfooterCustom.UIFAQsHyperlink;
            #endregion

            // Click 'FAQs' link
            Mouse.Click(uIFAQsHyperlink, new Point(22, 29));
            string checkurl = this.UIVillaHolidaysThatYouWindow.Uri.ToString();
            if (checkurl.Contains("faq"))
            {
    ...
    public class UIPanelfooterCustom : HtmlCustom
    {
        ...
        #region Properties
        public HtmlHyperlink UIFAQsHyperlink
        {
            get
            {
                if ((this.mUIFAQsHyperlink == null))
                {
                    this.mUIFAQsHyperlink = new HtmlHyperlink(this);
                    #region Search Criteria
                    this.mUIFAQsHyperlink.SearchProperties[HtmlHyperlink.PropertyNames.Id] = null;
                    this.mUIFAQsHyperlink.SearchProperties[HtmlHyperlink.PropertyNames.Name] = null;
                    this.mUIFAQsHyperlink.SearchProperties[HtmlHyperlink.PropertyNames.Target] = null;
                    this.mUIFAQsHyperlink.SearchProperties[HtmlHyperlink.PropertyNames.InnerText] = "FAQs";
                    this.mUIFAQsHyperlink.FilterProperties.Add(new PropertyExpression(HtmlHyperlink.PropertyNames.AbsolutePath, "/faq", PropertyExpressionOperator.Contains));
                    this.mUIFAQsHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.Title] = "";
                    this.mUIFAQsHyperlink.FilterProperties.Add(new PropertyExpression(HtmlHyperlink.PropertyNames.Href, "http://m.villaplus.com/faq", PropertyExpressionOperator.Contains));
                    this.mUIFAQsHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.Class] = "";
                    this.mUIFAQsHyperlink.FilterProperties.Add(new PropertyExpression(HtmlHyperlink.PropertyNames.ControlDefinition, "href=\"/faq\"", PropertyExpressionOperator.Contains));
                    this.mUIFAQsHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.TagInstance] = "2";
                    this.mUIFAQsHyperlink.WindowTitles.Add("Villa Holidays That You’ll Love More | Villa Plus");
                    #endregion
                }
                return this.mUIFAQsHyperlink;
            }
        }
        #endregion
        
        #region Fields
        private HtmlHyperlink mUIFAQsHyperlink;
        #endregion
    }
}
