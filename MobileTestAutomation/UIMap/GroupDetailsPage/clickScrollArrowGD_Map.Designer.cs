...
namespace MobileTestAutomation.UIMap.GroupDetailsPage.clickScrollArrowGD_MapClasses
{
    ...
    public partial class clickScrollArrowGD_Map
    {
        ...
        /// <summary>
        /// clickScrollArrowGD_Method - Use 'clickScrollArrowGD_MethodExpectedValues' to pass parameters into this method.
        /// </summary>
        public void clickScrollArrowGD_Method()
        {
            #region Variable Declarations
            HtmlScrollBar uIItemScrollBar = this.UIVillaPlusGroupDetailWindow.UIVillaPlusGroupDetailDocument.UIItemScrollBar;
            #endregion

           // Mouse.Click(uIItemScrollBar);
            Mouse.MoveScrollWheel(uIItemScrollBar, -500);
            

            // Verify that the 'Enabled' property of scroll bar equals 'True'
            //Assert.AreEqual(this.clickScrollArrowGD_MethodExpectedValues.UIItemScrollBarEnabled, uIItemScrollBar.Enabled);
        }
        
        #region Properties
        public virtual clickScrollArrowGD_MethodExpectedValues clickScrollArrowGD_MethodExpectedValues
        {
            get
            {
                if ((this.mclickScrollArrowGD_MethodExpectedValues == null))
                {
                    this.mclickScrollArrowGD_MethodExpectedValues = new clickScrollArrowGD_MethodExpectedValues();
                }
                return this.mclickScrollArrowGD_MethodExpectedValues;
            }
        }
        ...
        #region Fields
        private clickScrollArrowGD_MethodExpectedValues mclickScrollArrowGD_MethodExpectedValues;
    ...
    /// <summary>
    /// Parameters to be passed into 'clickScrollArrowGD_Method'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.21005.1")]
    public class clickScrollArrowGD_MethodExpectedValues
    {
        ...
        /// Verify that the 'Enabled' property of scroll bar equals 'True'
        /// </summary>
        public bool UIItemScrollBarEnabled = true;
        #endregion
    }
        ...
        public HtmlScrollBar UIItemScrollBar
        {
            get
            {
                if ((this.mUIItemScrollBar == null))
                {
                    ...
                    this.mUIItemScrollBar.WindowTitles.Add("Villa Plus | Group Details");
                    this.SearchConfigurations.Add(SearchConfiguration.AlwaysSearch);
                    #endregion
                }
