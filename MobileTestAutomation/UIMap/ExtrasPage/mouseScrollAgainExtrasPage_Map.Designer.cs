...
namespace MobileTestAutomation.UIMap.ExtrasPage.mouseScrollAgainExtrasPage_MapClasses
{
    ...
    public partial class mouseScrollAgainExtrasPage_Map
    {
        ...
        /// <summary>
        /// mouseScrollAgainExtrasPage_Method - Use 'mouseScrollAgainExtrasPage_MethodExpectedValues' to pass parameters into this method.
        /// </summary>
        public void mouseScrollAgainExtrasPage_Method()
        {
            ...
            //Assert.AreEqual(this.mouseScrollAgainExtrasPage_MethodExpectedValues.UIItemScrollBarExists, uIItemScrollBar.Exists);
        }
        
        #region Properties
        public virtual mouseScrollAgainExtrasPage_MethodExpectedValues mouseScrollAgainExtrasPage_MethodExpectedValues
        {
            get
            {
                if ((this.mmouseScrollAgainExtrasPage_MethodExpectedValues == null))
                {
                    this.mmouseScrollAgainExtrasPage_MethodExpectedValues = new mouseScrollAgainExtrasPage_MethodExpectedValues();
                }
                return this.mmouseScrollAgainExtrasPage_MethodExpectedValues;
            }
        }
        ...
        #region Fields
        private mouseScrollAgainExtrasPage_MethodExpectedValues mmouseScrollAgainExtrasPage_MethodExpectedValues;
    ...
    /// <summary>
    /// Parameters to be passed into 'mouseScrollAgainExtrasPage_Method'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.31101.0")]
    public class mouseScrollAgainExtrasPage_MethodExpectedValues
    {
