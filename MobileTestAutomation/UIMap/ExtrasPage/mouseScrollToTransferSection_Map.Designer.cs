...
namespace MobileTestAutomation.UIMap.ExtrasPage.mouseScrollToTransferSection_MapClasses
{
    ...
    public partial class mouseScrollToTransferSection_Map
    {
        ...
        /// <summary>
        /// mouseScrollToTransferSection_Method - Use 'mouseScrollToTransferSection_MethodExpectedValues' to pass parameters into this method.
        /// </summary>
        public void mouseScrollToTransferSection_Method()
        {
            ...
            if (uIItemScrollBar.Exists)
            {
                ...
                Mouse.MoveScrollWheel(-12);
            }

            // Verify that the 'Exists' property of scroll bar equals 'True'
           // Assert.AreEqual(this.mouseScrollToTransferSection_MethodExpectedValues.UIItemScrollBarExists, uIItemScrollBar.Exists);
        }
        
        #region Properties
        public virtual mouseScrollToTransferSection_MethodExpectedValues mouseScrollToTransferSection_MethodExpectedValues
        {
            get
            {
                if ((this.mmouseScrollToTransferSection_MethodExpectedValues == null))
                {
                    this.mmouseScrollToTransferSection_MethodExpectedValues = new mouseScrollToTransferSection_MethodExpectedValues();
                }
                return this.mmouseScrollToTransferSection_MethodExpectedValues;
            }
        }
        ...
        #region Fields
        private mouseScrollToTransferSection_MethodExpectedValues mmouseScrollToTransferSection_MethodExpectedValues;
    ...
    /// <summary>
    /// Parameters to be passed into 'mouseScrollToTransferSection_Method'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.31101.0")]
    public class mouseScrollToTransferSection_MethodExpectedValues
    {
