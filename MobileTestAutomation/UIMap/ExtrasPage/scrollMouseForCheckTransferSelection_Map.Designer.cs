...
namespace MobileTestAutomation.UIMap.ExtrasPage.scrollMouseForCheckTransferSelection_MapClasses
{
    ...
    public partial class scrollMouseForCheckTransferSelection_Map
    {
        ...
        /// <summary>
        /// scrollMouseForCheckTransferSelection_Method - Use 'scrollMouseForCheckTransferSelection_MethodExpectedValues' to pass parameters into this method.
        /// </summary>
        public void scrollMouseForCheckTransferSelection_Method()
        {
            ...
            //Assert.AreEqual(this.scrollMouseForCheckTransferSelection_MethodExpectedValues.UIItemScrollBarExists, uIItemScrollBar.Exists);
        }
        
        #region Properties
        public virtual scrollMouseForCheckTransferSelection_MethodExpectedValues scrollMouseForCheckTransferSelection_MethodExpectedValues
        {
            get
            {
                if ((this.mscrollMouseForCheckTransferSelection_MethodExpectedValues == null))
                {
                    this.mscrollMouseForCheckTransferSelection_MethodExpectedValues = new scrollMouseForCheckTransferSelection_MethodExpectedValues();
                }
                return this.mscrollMouseForCheckTransferSelection_MethodExpectedValues;
            }
        }
        ...
        #region Fields
        private scrollMouseForCheckTransferSelection_MethodExpectedValues mscrollMouseForCheckTransferSelection_MethodExpectedValues;
    ...
    /// <summary>
    /// Parameters to be passed into 'scrollMouseForCheckTransferSelection_Method'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.31101.0")]
    public class scrollMouseForCheckTransferSelection_MethodExpectedValues
    {
