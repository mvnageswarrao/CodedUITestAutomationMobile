...
namespace MobileTestAutomation.UIMap.FlightsPage.clickViewSummary_MapClasses
{
    ...
    public partial class clickViewSummary_Map:logWriter
    {
        public void clickViewSummary_Method()
        {
            #region Variable Declarations
            HtmlHyperlink uIViewSummaryHyperlink = this.UIHttpmobstagingvillapWindow.UIHttpmobstagingvillapDocument.UIBookPane.UIViewSummaryHyperlink;
            #endregion
            try
            {
                Mouse.Click(uIViewSummaryHyperlink, new Point(666, 3));
                WriteLogs("PASS : \"View Summary\" is Clicked from Flights Page.");
            }
            catch (Exception ex)
            {
                WriteLogs("FAIL : Could NOT Click \"View Summary\".");
    ...
    public class UIBookPane : HtmlDiv
    {
                ...
                base(searchLimitContainer)
        {
            ...
            this.FilterProperties.Add(new PropertyExpression(HtmlDiv.PropertyNames.InnerText, "Yes\r\n", PropertyExpressionOperator.Contains));
        ...
        #region Properties
        public HtmlHyperlink UIViewSummaryHyperlink
        {
            get
            {
                if ((this.mUIViewSummaryHyperlink == null))
                {
                    this.mUIViewSummaryHyperlink = new HtmlHyperlink(this);
                    #region Search Criteria
                    this.mUIViewSummaryHyperlink.SearchProperties.Add(new PropertyExpression(HtmlHyperlink.PropertyNames.InnerText, "\r\n View Summary", PropertyExpressionOperator.Contains));
                    this.mUIViewSummaryHyperlink.FilterProperties.Add(new PropertyExpression(HtmlHyperlink.PropertyNames.AbsolutePath, "/", PropertyExpressionOperator.Contains));
                    this.mUIViewSummaryHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.Href] = "javascript://";
                    this.mUIViewSummaryHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.Class] = "view-summary";
                    this.mUIViewSummaryHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.ControlDefinition] = "class=\"view-summary\" href=\"javascript://";
                    this.mUIViewSummaryHyperlink.WindowTitles.Add("http://mobstaging.villaplus.com/booking/");
                    #endregion
                }
                return this.mUIViewSummaryHyperlink;
            }
        }
        #endregion
        
        #region Fields
        private HtmlHyperlink mUIViewSummaryHyperlink;
        #endregion
    }
}
