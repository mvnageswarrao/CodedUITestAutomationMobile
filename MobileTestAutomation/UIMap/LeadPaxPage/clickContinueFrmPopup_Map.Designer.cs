...
namespace MobileTestAutomation.UIMap.LeadPaxPage.clickContinueFrmPopup_MapClasses
{
    ...
    public partial class clickContinueFrmPopup_Map:logWriter
    {
        public void clickContinueFrmPopup_Method()
        {
            #region Variable Declarations
            HtmlInputButton uIContinueButton = this.UIVillaPlusBookingTermWindow.UIVillaPlusBookingTermDocument.UIContinueButton;
            #endregion
            try
            {
                Mouse.Click(uIContinueButton, new Point(567, 23));
                WriteLogs("PASS : Clicked \"Continue\" Button from TLS Popup. : VERIFICATION");
            }
            catch (Exception ex)
            {
                WriteLogs("FAIL : Could Not click \"Continue\" Button from TLS Popup.");
        ...
        public HtmlInputButton UIContinueButton
        {
            get
            {
                if ((this.mUIContinueButton == null))
                {
                    ...
                    #region Search Criteria
                    this.mUIContinueButton.SearchProperties[HtmlButton.PropertyNames.Id] = "BtnTLSContinue";
                    this.mUIContinueButton.SearchProperties[HtmlButton.PropertyNames.DisplayText] = "Continue";
                    this.mUIContinueButton.SearchProperties[HtmlButton.PropertyNames.Type] = "button";
                    this.mUIContinueButton.FilterProperties[HtmlButton.PropertyNames.Class] = "btn bg-green";
                    this.mUIContinueButton.FilterProperties[HtmlButton.PropertyNames.ControlDefinition] = "class=\"btn bg-green\" id=\"BtnTLSContinue\"";
                    this.mUIContinueButton.WindowTitles.Add("Villa Plus | Booking Terms and Conditions");
                    #endregion
                }
