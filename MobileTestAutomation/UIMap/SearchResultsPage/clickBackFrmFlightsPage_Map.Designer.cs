...
namespace MobileTestAutomation.UIMap.SearchResultsPage.clickBackFrmFlightsPage_MapClasses
{
    ...
    public partial class clickBackFrmFlightsPage_Map:logWriter
    {
        
        /// <summary>
        /// clickBackFrmFlightsPage_Method
        /// </summary>
        public void clickBackFrmFlightsPage_Method()
        {
            #region Variable Declarations
            HtmlCustom uIBookingBackCustom = this.UIVillaPlusBookingInteWindow.UIVillaPlusBookingDocument.UIBookingBackCustom;
            #endregion
            try
            {
                // Click 'bookingBack' custom control
                Mouse.Click(uIBookingBackCustom, new Point(36, 10));
                WriteLogs("PASS : Clicked \"Back\" Button from \"Flights\" Page.");
            }
            catch (Exception ex)
            {
                WriteLogs("FAIL : Could not click \"Back\" Button from \"Flights\" Page.");
    ...
    public class UIVillaPlusBookingDocument : HtmlDocument
    {
        ...
        #region Properties
        public HtmlCustom UIBookingBackCustom
        {
            get
            {
                if ((this.mUIBookingBackCustom == null))
                {
                    this.mUIBookingBackCustom = new HtmlCustom(this);
                    #region Search Criteria
                    this.mUIBookingBackCustom.SearchProperties["TagName"] = "A";
                    this.mUIBookingBackCustom.SearchProperties["Id"] = "bookingBack";
                    this.mUIBookingBackCustom.FilterProperties["Class"] = "MousePointer";
                    this.mUIBookingBackCustom.FilterProperties["ControlDefinition"] = "class=\"MousePointer\" id=\"bookingBack\" on";
                    this.mUIBookingBackCustom.WindowTitles.Add("Villa Plus | Booking");
                    #endregion
                }
                return this.mUIBookingBackCustom;
            }
        }
        #endregion
        
        #region Fields
        private HtmlCustom mUIBookingBackCustom;
        #endregion
    }
}
